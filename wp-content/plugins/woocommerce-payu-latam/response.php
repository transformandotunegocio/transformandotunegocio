...
?>
	...
	<main class="main_gracias">
        <?php
            if(!wp_is_mobile()){
              ?>
              <img src="<?=IMGURL?>gracias.png" alt="">
              <?php
            }else{
              ?>
              <img src="<?=IMGURL?>gracias_1.png" alt="">
              <img src="<?=IMGURL?>gracias_2.png" alt="">
              <?php
            }
        ?>
    </main>
	...
	<center>
		<table style="width: 100%;margin-top: 50px;color: #fff;max-width: 800px;">
			<tr align="center">
